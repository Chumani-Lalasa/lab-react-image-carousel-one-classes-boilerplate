        ...
        return (
          ...
          <div className="main-container">
            <div className="btn-container">
                <div>
                    <button className="left-btn" onClick={this.prev}><ArrowBackIosIcon  style={{fill:"white"}}/></button>
                </div>
                <div>
                    <button className="right-btn" onClick={this.next}><ArrowForwardIosIcon style={{fill:"white"}}/></button>
                </div>
            </div>
            ...
            <span className="text sub-title">{images[this.state.currImageIndex].subtitle}</span>
            </div>
            </div>
